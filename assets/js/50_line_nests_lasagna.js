...
am.createLineSeries(chartActualProduction, "PV - Calibratore 1 PV Spessore DX", "time", "Nidi_Lasagna_Motori_Calibratore_1_PV_Spessore_DX", 1, false, false)
am.createLineSeries(chartActualProduction, "PV - PV - Calibratore 2 PV Spessore SX", "time", "Nidi_Lasagna_Motori_Calibratore_1_PV_Spessore_SX", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Calibratore 1 PV Spessore DX", "time", "Nidi_Lasagna_Motori_Calibratore_2_PV_Spessore_DX", "", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Calibratore 2 PV Spessore SX", "time", "Nidi_Lasagna_Motori_Calibratore_2_PV_Spessore_SX", "", 1, false, true)
...
query += 'mean("Nidi_Lasagna_Motori_Calibratore_1_PV_Spessore_DX") as "Calibratore_1_PV_Spessore_DX", '
query += 'mean("Nidi_Lasagna_Motori_Calibratore_1_PV_Spessore_SX") as "Calibratore_1_PV_Spessore_SX", '
query += 'mean("Nidi_Lasagna_Motori_Calibratore_2_PV_Spessore_DX") as "Calibratore_2_PV_Spessore_DX", '
query += 'mean("Nidi_Lasagna_Motori_Calibratore_2_PV_Spessore_SX") as "Calibratore_2_PV_Spessore_SX" '
...
async function setCardsValue(entityName){
  // Richiama il servizio di thingworx.
	tw.getLineNidiLasagnaInfo(entityName)
		.then(info => {
