...
am.createLineSeries(chartActualProduction, "PV - Impilatore Motori Catena  Velocità", "time", "Impilatore_Motori_Catena_PV_Velocita", "Canne/min", 1, false, true)
am.createLineSeries(chartActualProduction, "SP - Impilatore Motori Catena Velocita ", "time", "Impilatore_Motori_Catena_SP_Velocita", "", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Impilatore Motori Catena Corrente", "time", "Impilatore_Motori_Catena_PV_Corrente", "kg", 1, false, true)
am.createLineSeries(chartActualProduction, "SP - Impilatore Motori Catena Corrente", "time", "Impilatore_Motori_Catena_SP_Corrente", "sec", 1, false, true)
am.createLineSeries(chartActualProduction, "PV - Impilatore Motori Catena Potenza", "time", "Impilatore_Motori_Catena_PV_Potenza", "kg", 1, false, true)
am.createLineSeries(chartActualProduction, "SP - Impilatore Motori Catena Potenza", "time", "Impilatore_Motori_Catena_SP_Potenza", "sec", 1, false, true)
...
am.createLineSeries(chartHistoryProduction, "PV - Impilatore Motori Catena  Velocità", "time", "Impilatore_Motori_Catena_PV_Velocita", "Canne/min", 1, false, true)
am.createLineSeries(chartHistoryProduction, "SP - Impilatore Motori Catena Velocita ", "time", "Impilatore_Motori_Catena_SP_Velocita", "", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Impilatore Motori Catena Corrente", "time", "Impilatore_Motori_Catena_PV_Corrente", "kg", 1, false, true)
am.createLineSeries(chartHistoryProduction, "SP - Impilatore Motori Catena Corrente", "time", "Impilatore_Motori_Catena_SP_Corrente", "sec", 1, false, true)
am.createLineSeries(chartHistoryProduction, "PV - Impilatore Motori Catena Potenza", "time", "Impilatore_Motori_Catena_PV_Potenza", "kg", 1, false, true)
am.createLineSeries(chartHistoryProduction, "SP - Impilatore Motori Catena Potenza", "time", "Impilatore_Motori_Catena_SP_Potenza", "sec", 1, false, true)
...
async function setCardsValue(entityName) {
	...
	tw.getLineDeimpilatoreInfo(entityName)
		.then(info => {
