...
// // Remove underscores from name and display in the field
// $('#IDCustomerName').text(selectedCustomer.replace(/_/g, " "));
// $("#IDBreadcrumbCustomer").text(selectedCustomer.replace(/_/g, ' '));

// // Retrieve the language used by the user and replace all texts
// lang.getLanguage();
...
// // Fetch general data of the lines installed by the customer
// promises.push(
...
// // Fetch general data of the dryers installed by the customer
// promises.push(
...
// // Function to set values for line cards
// function setLineCardsValue(entityName) {
//   tw.service_02_getLinesGeneralInfo(entityName)
//     .then(result => {
//       result.array.forEach((item, i) => {
...
// // Function to set values for dryer cards
// function setDryersCardsValue(entityName) {
//   tw.service_01_getDryersGeneralInfo(entityName)
//     .then(result => {
//       if (result.entityName) {
...
// // Function to set dryers trend data
// function setDryersTrend(chart, query) {
//   tw.influxQuery(query)
//     .then(response => {
//       let data = [];
